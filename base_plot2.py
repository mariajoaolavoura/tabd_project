...
for reds in colors[360]:
    if reds == 'red':
        cum_infected_1sth += 1
print(cum_infected_1sth)

cum_infected_2ndh=0
for reds in colors[360+360]:
    if reds == 'red':
        cum_infected_2ndh += 1
print(cum_infected_1sth+cum_infected_2ndh)
"""
infected_cum=[]
...
print(infected_cum)
plt.scatter(range(24),infected_cum)
plt.show()
"""
